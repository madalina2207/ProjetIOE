...
export class Model2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.engine = new Engine(this.canva, true)
...
/*
    ...
    var camera1 = new ArcRotateCamera("camera1", Math.PI / 2, Math.PI / 4, 10, new BABYLON.Vector3(0, -5, 0), scene);
    scene.activeCamera = camera1;
    scene.activeCamera.attachControl(this.canva, true);
